...
#    The shape of pool_5: 7 x 7 x 512
    ...
    output = Dense(512, activation = 'relu', name = 'dsc_1')(output)
    output = Dropout(rate = 0.5, name = 'dropout')(output)
    output = Dense(classes, activation = 'softmax', name = 'dsc_2')(output)
...
if __name__ == '__main__':
    ...
    plot_model(model, to_file = 'model_share_dense_d_split.png', show_shapes = True, show_layer_names = True)
